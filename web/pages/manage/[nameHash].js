...
export default function ManageDomain() {
    ...
    async function updateBio() {
        try{
            setLoadinf(true);
            const txId = await updateAddressForDomain(router.query.nameHash, bio);
    ...
    async function renew() {
        try{
            ...
            const duration = (renewFot * SECONDS_PER_YEAR).toFixed(1).toString();
            ...
            <main className={styles.main}>
                <div>
                    ...
                    <p>
                        Created At: {" "}
                        {new Date(
                            parseInt(domainInfo.createdAt.createdAt) *1000
                        ).toLocaleDateString()}
                    </p>
                    <p>
                        Expires At: {" "}
                ...
                <div>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <input 
                            ...
                            />
                            <button onClick={updateBio} disabled={loading}>Update</button>
                    </div>
